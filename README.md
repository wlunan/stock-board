...
- **系统托盘** — 最小化到系统托盘，双击托盘图标显示/隐藏窗口，托盘右键菜单控制
...
| `refresh_interval` | `int` | `30` | 自动刷新间隔（秒），最小 1 |
| `font_size` | `int` | `18` | 字体大小（像素），范围 10-48 |
| `skip_non_trading_hours` | `bool` | `true` | `true` = 非交易时段不请求行情（A 股 9:30-11:30/13:00-15:00，港股 9:30-12:00/13:00-16:00）；`false` = 始终按间隔刷新 |
